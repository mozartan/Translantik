...
public class CarGenerator {
    ...
    public static void newCarGenerator() throws InterruptedException {
        ...
        Driver.get().findElements(By.className("select2-result-label")).get(random.nextInt(2)).click();
        Thread.sleep(1000);
        createCarPage.fuelType.click();
        Driver.get().findElements(By.className("select2-result-label")).get(random.nextInt(4)).click();
